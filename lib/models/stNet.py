...
def load_model(model, model_path, optimizer=None, resume=False,
    ...
    start_epoch = 0
    checkpoint = torch.load(model_path, map_location="cuda") # lambda storage, loc: storage
    ...
    if optimizer is not None and resume:
        if 'optimizer' in checkpoint:
            ...
            # optimizer.param_groups[1]['lr'] = start_lr * 0.1
...
if __name__ == '__main__':
    ...
    for model_name in model_nameAll:
        ...
        input = torch.rand(1,5,3,1024,1024).to(device)
