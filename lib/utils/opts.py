...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--model_name', default='DLAIterUpdate',
        ...
        self.parser.add_argument('--sample_area', type=int, default=512)
        self.parser.add_argument('--enlarge', type=bool, default=False)
        self.parser.add_argument('--enlarge_scale', type=float, default=1.25)

        self.parser.add_argument('--track_thresh', type=float, default=0.3)
        self.parser.add_argument('--track_buffer', type=int, default=20)
